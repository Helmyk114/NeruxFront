...
export class ValidationRules {
  ...
  static minLength(min: number, option?: ValidatioOption) {
    ...
    return Yup.string().test(
      "minLength",
      message || `${campo} debe tener al menos ${min} caracteres`,
      function (value) {
  ...
  static maxLength(max: number, option?: ValidatioOption) {
    ...
    return Yup.string().test(
      "maxLength",
      message || `El campo ${campo} debe tener como máximo ${max} caracteres`,
      function (value) {
        return value && value.length <= max
          ...
          : this.createError({
              message: `${
                message ||
                `El campo ${campo} debe tener como máximo ${max} caracteres`
              }`,
            });
      }
    );
  ...
  static upperCase(option?: ValidatioOption) {
    ...
    return Yup.string().test(
      "upperCase",
      message || `La ${campo} debe contener al menos una letra mayúscula`,
      function (value) {
        const regex = /[A-Z]/;
        return regex.test(value || "")
          ...
          : this.createError({
              message: `${
                message ||
                `La ${campo} debe contener al menos una letra mayúscula`
              }`,
            });
      }
    );
  ...
  static lowerCase(option?: ValidatioOption) {
    ...
    return Yup.string().test(
      "lowerCase",
      message || `La ${campo} debe contener al menos una letra minúscula`,
      function (value) {
        const regex = /[a-z]/;
        return regex.test(value || "")
          ? true
          : this.createError({
              message: `${
                message ||
                `La ${campo} debe contener al menos una letra minúscula`
              }`,
            });
      }
    );
  ...
  static number(option?: ValidatioOption) {
    ...
    return Yup.string().test(
      "number",
      message || `${campo} debe contener al menos un número`,
      function (value) {
        const regex = /[0-9]/;
        return regex.test(value || "")
          ? true
  ...
  static specialCharacter(option?: ValidatioOption) {
    ...
    return Yup.string().test(
      "specialChar",
      message || `La ${campo} debe contener al menos un carácter especial`,
      function (value) {
        const regex = /[!@#$%^&*(),.?":{}|<>]/;
        return regex.test(value || "")
          ? true
          : this.createError({
              message: `${
                message ||
                `La ${campo} debe contener al menos un carácter especial`
              }`,
            });
      }
    );
    ...
    return Yup.string().test(
      ...
      function (value) {
        return value === this.resolve(Yup.ref(ref))
          ? true
          : this.createError({
              message: `${message || `El ${campo} no coincide`}`,
            });
      }
    );
  }
