...
const Sidebar = () => {
  ...
  return (
    <aside className={`h-screen ${isCollapsed ? "w-16" : "w-64"} bg-grisFondo2 text-white flex flex-col transition-all duration-300`}>
     ...
     onClick={toggleSidebar}/>}>
      ...
      <nav className="flex-1 mt-4">
        <ul className="space-y-2">
          <li >
          <SidebarLink
          href='#inicio' label={isCollapsed ? "" : "Inicio"}
