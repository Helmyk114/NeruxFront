...
const PlantillaGenerica: React.FC<PlantillaProps> = ({izquierda, derecha}) => (
   ...
   <div className="absolute inset-0 w-1/2  bg-background2 rounded-l-radius-34 ">{izquierda}</div>
   <div className="absolute inset-y-0 right-0 w-1/2 bg-background2 rounded-r-radius-34">{derecha}</div>
   </div> 
)
